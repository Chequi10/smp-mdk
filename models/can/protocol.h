/**
 * @file protocol.h
 * @author Acerbo Ezequiel (acerboezeqiuiel@live.com)
 * @brief Protocolo de comunicacion baasado en paquetes, inspirado en Mavlink y otros similares. 
 *        Donde se organiza la reepcion y envios de mensajes al puerto serie.
 * @version 0.1
 * @date 2024-04-17
 * 
...
#define PACKET_TIMEOUT_IN_MS 300
